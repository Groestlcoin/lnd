...
const (
	// mainnetSCBLaunchBlock is the approximate block height of the groestlcoin
	// mainnet chain of the date when SCBs first were released in lnd
	// (v0.8.1-grs). The block date is Fri, 13 Dec 2019 21:50:52 UTC.
	mainnetSCBLaunchBlock = 2878287

	// testnetSCBLaunchBlock is the approximate block height of the groestlcoin
	// testnet3 chain of the date when SCBs first were released in lnd
	// (v0.8.1-grs). The block date is Fri, 13 Dec 2019 21:52:31 UTC.
	testnetSCBLaunchBlock = 1440874
)
